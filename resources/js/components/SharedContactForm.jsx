...
export default function SharedContactForm({ source, service = '', dark = false, onSuccess }) {
  ...
  return <div style={{background:bg,color:fg,border:'1px solid #94a3b844',borderRadius:16,padding:22}}><h3 style={{marginTop:0}}>درخواست تماس</h3><p style={{fontSize:13,color:'#94a3b8'}}></p>
