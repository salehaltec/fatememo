  ...
  service: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "پایگاه دانش داریم و نسبتاً به‌روز می‌کنیم", score: 3 },
...
const WHAT_IT_IS = [
  ...
  { icon: "📊", title: "نه گزارش کلی", desc: "متناسب با حوزه های مختلف بازرگانی، تولیدی و خدماتی شخصی‌سازی شده" },
  { icon: "🎯", title: "همان سوالاتی که مشاور می‌پرسد", desc: "شما بخشی از سوالات اولین جلسه مشاوره را رایگان دریافت می‌کنید" },
];
    ...
    return (
      <div style={styles.container}>
        ...
        <h1 style={{ ...styles.heroTitle, fontSize: "clamp(1.7rem,5.5vw,2.8rem)" }}>
          کسب‌وکار شما<br />
          <span style={{ color: "#a78bfa" }}>یک مشکل پنهان دارد</span><br />
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={{ ...styles.heroSub, fontSize: "0.88rem" }}>
        ...
        <h3>
            انتخاب کنید که کسب و کار شما در کدام دسته بندی قرار می‌گیرد؟
        </h3>
